...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаСотрудники)
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаСотрудники.МестоРожденияВСвидетельстве) Тогда 
			...
			НаборЗаписейМестоРожденияИзСтрахового.ГородРождения = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(МестоРожденияИзСтрахового.НаселенныйПункт)), Сокращение);
			НаборЗаписейМестоРожденияИзСтрахового.РайонРождения = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(МестоРожденияИзСтрахового.Район)), Сокращение);
...
Функция СформироватьПечатнуюФормуАДВ3(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Пока ВыборкаСотрудники.Следующий() Цикл
			...
			МестоРожденияВСвидетельстве.НаселенныйПункт = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(МестоРожденияВСвидетельстве.НаселенныйПункт)), Сокращение);
			...
			МестоРожденияВСвидетельстве.Район = РегламентированнаяОтчетность.ПолучитьИмяИАдресноеСокращение(ВРЕГ(СокрЛП(МестоРожденияВСвидетельстве.Район)), Сокращение);
