...
Функция ПечатьОписиЗаявленийСотрудниковНаВыплатуПособий(МассивСсылок, ОбъектыПечати)
	...
	|	ДокументОпись.Телефон КАК Телефон,
	|	ДокументОпись.ДолжностьУполномоченного КАК ДолжностьУполномоченного,
	|	ДокументОпись.ФИОУполномоченного КАК ФИОУполномоченного,
	|	ВЫБОР
