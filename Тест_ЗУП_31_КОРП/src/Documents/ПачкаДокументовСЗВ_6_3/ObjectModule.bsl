...
Функция ОграниченияРегистрации() Экспорт
	...
	Возврат ОбменДаннымиЗарплатаКадры.ОграниченияРегистрацииПоОрганизацииИФизическимЛицам(ЭтотОбъект, Организация, МассивПараметров, Дата(ОтчетныйПериод, 12, 31));
