...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОбменЗарплатаERP") Тогда 
			...
			ПроверятьМестоВСтруктуреПредприятия = Модуль.СтруктураПредприятияИспользуетсяДляОтраженияЗарплатыВРегламентированномУчете();
		КонецЕсли;
...
Функция ОграниченияРегистрации() Экспорт
	...
	МассивПараметров.Добавить(Новый Структура("РасчетРезерваОтпусков", "Сотрудник"));
