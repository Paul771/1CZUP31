...
// Параметры:
//  Объект - отчет
//  ДополнительныеПоляПредставлений - Структура с ключами - именами предстаалений запросов
//										Значение- Массив с описанием дополнительных полей.
//
Процедура ЗаполнитьОбщиеИсточникиДанныхОтчета(Объект, ДополнительныеПоляПредставлений = Неопределено) Экспорт
	
	Если ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных() Тогда
		
		ЗаполнитьОбщиеЗапросы(Объект.СхемаКомпоновкиДанных.НаборыДанных);
...
Процедура ЗаполнитьОбщиеЗапросы(НаборыДанных)
	...
	Для Каждого НаборДанных Из НаборыДанных Цикл
		...
		ИначеЕсли ТипЗнч(НаборДанных) = Тип("НаборДанныхОбъединениеСхемыКомпоновкиДанных") Тогда
			ЗаполнитьОбщиеЗапросы(НаборДанных.Элементы);
		КонецЕсли;
...
//		* Соединения				- Массив, соединения с таблицами, для которых Источник, является Источникм связи.
//
...
Функция ЗапросПредставленияКадровыеДанныеСотрудниковАнализНачисленийИУдержаний(ТекстИсходногоЗапроса) Экспорт
	...
	Возврат ЗарплатаКадрыОбщиеНаборыДанныхВнутренний.ЗапросПредставленияКадровыеДанныеСотрудниковАнализНачисленийИУдержаний(ТекстИсходногоЗапроса);
	
КонецФункции

Функция ПолучитьТекстОбщегоЗапроса(ИмяИсточникаДанных)
	
	Если ОбщегоНазначенияКлиентСервер.РежимОтладки() Тогда
		Возврат ЗарплатаКадрыОбщиеНаборыДанныхВнутренний.ПолучитьТекстОбщегоЗапроса(ИмяИсточникаДанных);
	Иначе
		Возврат ЗарплатаКадрыОбщиеНаборыДанныхПовтИсп.ПолучитьТекстОбщегоЗапроса(ИмяИсточникаДанных);
	КонецЕсли;
