...
// КонецЦикла;
//
// КоличествоНовостей = СписокДобавленныхНовостей.Количество(); // Количество важных + очень важных, вне зависимости от
// признака прочтенности. Если КоличествоНовостей > 0 Тогда
