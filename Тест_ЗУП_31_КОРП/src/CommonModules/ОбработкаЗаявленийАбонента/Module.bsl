...
Функция ВыгрузитьЗаявлениеАбонентаВМоделиСервиса(Знач ЗаявлениеАбонента) Экспорт
	...
	Если ЗаявлениеАбонента.ПодписатьЭП Тогда
		Результат = МенеджерСервисаКриптографии.СформироватьЗаявлениеДляПодписания(ПодготовитьЗаявление(ЗаявлениеАбонента));
	Иначе
...
Функция ПодготовитьЗаявление(ДокументЗаявление) Экспорт
