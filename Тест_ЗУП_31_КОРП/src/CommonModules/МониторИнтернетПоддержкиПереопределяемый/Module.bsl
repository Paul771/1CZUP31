...
Процедура ИспользоватьМониторИнтернетПоддержки(Отказ) Экспорт
	...
	КонфигурацииЗарплатаКадры.ИспользоватьМониторИнтернетПоддержки(Отказ);	
...
Процедура ИспользоватьОтображениеМонитораПриНачалеРаботы(Использование) Экспорт
	...
	КонфигурацииЗарплатаКадры.ИспользоватьОтображениеМонитораПриНачалеРаботы(Использование);
