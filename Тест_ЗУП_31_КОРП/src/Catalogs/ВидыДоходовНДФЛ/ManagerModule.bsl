...
Процедура ЗаполнитьКодыДоходов2018() Экспорт 
	...
	ОписатьКодДоходаНДФЛ( , Ставка13, "3023", "Сумма дохода, получаемого по обращающимся облигациям, номинированным в рублях и эмитированным после 1 января 2017 года");
