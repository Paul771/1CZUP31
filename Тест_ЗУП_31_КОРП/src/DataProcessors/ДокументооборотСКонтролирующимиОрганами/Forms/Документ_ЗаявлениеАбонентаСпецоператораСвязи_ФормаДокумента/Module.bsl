...
Процедура СформироватьТаблицуИзмененныхДанных()
	...
	Если КриптопровайдерИзменился И НЕ ПереходВОблако Тогда
		...
		ДобавитьВТаблицу(Перечисления.ПараметрыПодключенияК1СОтчетности.ИзменениеКриптопровайдера, ОтображаемоеНазваниеКриптопровайдера, КриптопровайдерИзменился);
