...
Процедура УправлениеЗакладкойУведомлений(Вид = Неопределено)
	...
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОКонтролируемыхСделках) И НЕ СуществуетРегламентированныйОтчетРозничныеЦеныНаТабак()
		И НЕ ЗначениеЗаполнено(ИмяДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ) Тогда
	...
	Если Вид = "Файлы" Тогда
		...
		КонецЦикла;
		ВидыУведомлений.Добавить(ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ"));
