...
Процедура УправлениеЭУГруппаНастройки()
	...
	Элементы.НастройкиОбмена.Заголовок = ЗаголовкиГруппы.ЗаголовокГиперссылкиНастроекОбмена;
...
Функция ЗаголовкиГруппыНастройки(Организация)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		ЗаголовокГиперссылкиНастроекОбмена = НСтр("ru = 'Настройки подключения и обмена'");
		
	Иначе
		ЗаголовокГиперссылкиНастроекОбмена = НСтр("ru = 'Настройки обмена с контролирующими органами'");
	...
	Результат.Вставить("ЗаголовокГиперссылкиНастроекОбмена", 	ЗаголовокГиперссылкиНастроекОбмена);
	Возврат Результат;
