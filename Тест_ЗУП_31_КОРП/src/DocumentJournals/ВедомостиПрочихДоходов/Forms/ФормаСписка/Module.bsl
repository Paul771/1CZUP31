...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВзаиморасчетыПоПрочимДоходамФормы.УстановитьУсловноеОформлениеФормыСписка(ЭтаФорма);
	...
	СтруктураПараметровОтбора = Новый Структура(НСтр("ru = 'Получатель'"), СтруктураПараметраФизическоеЛицо);
